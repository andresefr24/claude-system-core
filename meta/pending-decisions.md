...
| 2026-07-25 | Auditar que los fixes v0.7.0–v0.10.0 movieron su aguja (línea base por fix en `retro-2026-07-25.md`) | disciplina de auto-auditoría capa-3: los fixes shipearon el mismo día, sin poder medir | pendiente — medir en la retro 2026-08-01 |
| 2026-07-25 | Promote/demote explícito de los 3 skill candidates de MintStash "at threshold" desde hace ≥2 meses: prompt-writing para CC (abril, 25+ evidencias), visual audit con capturas (abril), MCP trust-debugging (mayo, 8+). Detalle en `mintstash-knowledge/skill-candidates.md` §Imminent | la sección "Imminent" exige promote o demote y lleva meses sin decisión — el pipeline de skills se atasca en el último paso (detectado en la auditoría del vault 2026-07-25; encargado por Andrés a la retro) | pendiente — decidir en la retro 2026-08-01 |
